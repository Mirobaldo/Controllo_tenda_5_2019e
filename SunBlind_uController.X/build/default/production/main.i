...
# 9 "C:\Program Files (x86)\Microchip\xc8\v2.05\pic\include\pic.h"
extern unsigned char __osccal_val(void);

# 52 "C:\Program Files (x86)\Microchip\xc8\v2.05\pic\include\pic12f675.h"
...
{
if((GPIObits.GP3==0b1) || (GPIObits.GP2==0b1))
cntRST=10*100;
else
if (cntRST>0) cntRST--;

if(GPIObits.GP4!=lastGPIO4mirror)
cntWD = 60*100;
else
if(cntWD>0) cntWD--;

lastGPIO4mirror=GPIObits.GP4;
...
{
if (Status) {TRISIO1 = 0b1; GPIObits.GP1 = 0b1;}
else {GPIObits.GP1 = 0b0; TRISIO1 = 0b0;}
