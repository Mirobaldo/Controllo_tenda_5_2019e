...
#define LedMatrix_VERSION_ "V4.191025.C" //Nuovo algoritmo grafico con correzioni
...
// Serial.print(F("§ MatrixWriteChar s[ptr]: "));      Serial.print(s[ptr]);    Serial.println(" ");
// -------------------------------------------------------------------------------------------------
...
//DBGSerial.print(F("$ Input data: "));  
//  for(uint8_t p=0; p<database->hdim; p++)
//  {
//    Serial.print(database->data[index].data[p]); Serial.print(F(" "));           
//  }
//DBGSerial.println(" <=");
...
//DBGSerial.print(F("$ Max "));       Serial.print(max_actual);     
//DBGSerial.print(F(", Min "));       Serial.print(min_actual);     
//DBGSerial.print(F(", Diff "));      Serial.print(diff);     
//DBGSerial.print(F(", Diff_min "));  Serial.print(diff_min);     
//DBGSerial.print(F(", Diff_max "));  Serial.println(diff_max);     
...
//      bardata[p]+=1;       
        ...
        bardata[p]=0;
//DBGSerial.print(bardata[p]); Serial.print(F(" "));    
    }
//DBGSerial.println(" <=");
  } 
  else
...
//DBGSerial.print(F("$ BarData(f) - Mult:"); Serial.print(mult);     
//DBGSerial.print(F(", Dat:"));               Serial.print(dat);     
//DBGSerial.print(F(", Bardata["));           Serial.print(p);     
//DBGSerial.print(F("]: "));                  Serial.println(bardata[p]);     
      }
      else 
        bardata[p]=1;
    }   
